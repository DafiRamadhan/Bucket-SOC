  ...
  render() {
    ...
    return (
      <View style={styles.pages}>
        <GestureRecognizer
          onSwipeLeft={() => navigation.navigate('Intro3')}
          ...
          <View style={styles.card}>
            <View style={styles.wrapTitle}>
              <Text style={styles.titleLeft}>Pilih Buket </Text>
              <Text style={styles.titleRight}>Favorit Anda</Text>
            </View>
            <Text style={styles.desc}>
              Pilih buket yang cocok untuk Anda atau orang yang ingin Anda
              berikan.
            </Text>
...
const styles = StyleSheet.create({
  ...
  images: {
    ...
    marginTop: responsiveHeight(132),
    marginBottom: responsiveHeight(122),
  },
  card: {
